...
- MkDocs-Dokumentation mit Material-Theme (EN/DE)
- Open-Source-Governance-Baseline (Community-Dateien, Issue/PR-Templates, CI-Workflow)
- Repository-Qualitäts-Baseline (`.editorconfig`, Analyzer via `Directory.Build.props`)
...
- Frontmatter-Support, Hierarchie-Auflösung und Page-ID Write-Back
- Unit- und Integrations-Testsuite
